...
.PHONY: css css-watch css-min test test-authz test-lockout render-capture render-check resync-triplestore tools lint-php fmt fmt-check analyse lint-house check token-diff
